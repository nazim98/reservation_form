...
It allows alphabetic characters (both uppercase and lowercase) and hyphens.
...
It matches the format "YYYY-MM-DDTHH:MM" (ISO 8601 format) commonly used for datetime input.
